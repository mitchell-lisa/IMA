...
Route map and payloads: [`docs/api.md`](docs/api.md). Scoring rules: [`docs/scoring-spec.md`](docs/scoring-spec.md). Question bank: [`docs/question-matrix.md`](docs/question-matrix.md). Data inventory: [`docs/privacy-data-map.md`](docs/privacy-data-map.md).
